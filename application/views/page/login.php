...
<head>
  ...
  <title>.: E-MOVEMENT PMII KOTA MALANG :.</title>
...
<body class="hold-transition login-page bg-green pace-warning" style="background-image: url(<?= base_url('/assets/dist/img/tiles.jpg')?>); background-repeat: no-repeat; background-size: cover;">
<div class="login-box">
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body rounded-circle">
      ...
      <form action="<?=site_url('auth/process')?>" method="post" id="FormLogin">
        ...
        <div class="row">          
          ...
          <div class="col-12">
            <hr>
            <a href="<?= base_url("daftar")?>" class="btn btn-outline-info btn-block"><i class="fas fa-dashboard"></i> DAFTAR</a>
          </div>
        </div>
