      ...
      <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title">Berdasarkan Sebaran Per Tahun</h3>
              ...
              <div class="card-body">
                <canvas id="perkembanganChart" style="min-height: 250px; height: 250px; max-width: 100%;"></canvas>
              </div>
              <!-- /.card-body-->
            </div>
            <!-- /.card -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title">Berdasarkan Sebaran Per Komisariat</h3>
              ...
              <div class="card-body">
                <canvas id="komisariatChart" style="min-height: 250px; height: 250px; max-width: 100%;"></canvas>
              </div>
              <!-- /.card-body-->
            </div>
            <!-- /.card -->
