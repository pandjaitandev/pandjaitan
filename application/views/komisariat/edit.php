        ...
        <?= form_open_multipart('')?>
          ...
          <div class="card-body">            
            ...
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                <div class="input-group-append"><div class="input-group-text"><span class="fas fa-user-plus"></span></div></div>
                <input type="text" class="form-control" name="kampus" placeholder="Ex: Universitas Negeri Malang" value="<?= $this->input->post('kampus') ?? $row->kampus?>" minlength="6" maxlenght="100" required>
              </div>                            
